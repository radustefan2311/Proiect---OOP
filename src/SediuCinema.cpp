...
SediuCinema::SediuCinema(const std::string &adresa, const std::string &program, const std::vector<Film> &filme, const std::vector<Rezervare> &rezervari) : adresa(adresa), program(program), filme(filme), rezervari(rezervari) {}
